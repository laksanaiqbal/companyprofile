...
<body class="hold-transition sidebar-mini dark-mode">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kelola Layanan</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-header">
                        <div class="card-tools">
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-info">
                                <i class="fa fa-plus-circle" aria-hidden="true">Tambah Layanan</i>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    @foreach($kelolalayanan as $item)
                    <tr align=center>
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $item->layanan }}</td>
                        <td><img src="{{ url('assets/layanan') }}/{{ $item->gambar }}" class="img-fluid" width="80"></td>
    ...
    <div class="modal fade" id="modal-info">
        <div class="modal-dialog">
            <form action="{{ route('tambahlayanan') }}" method="post" enctype="multipart/form-data">
                <div class="modal-content bg-info">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" id="layanan" name="layanan" class="form-control" placeholder="layanan">
                        </div>
                        <div class="form-group">
